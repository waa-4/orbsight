...
import {createPhysics,createOrbsightBody,updateBodySensors,driveBody,enforceAnatomy,syncBody,destroyBody} from "./physics-v012.js";
import {setupWorld,addObject,resetMap,updateWorld,clearObjects} from "./world-v012.js";
import {attachMind,updateMind,cleanupMind} from "./mind-v012.js";

const BUILD="0.12-posture-brain-2026-09-18";
const $=id=>document.getElementById(id);
$("status").textContent="v0.12 main.js loaded — initializing…";
...
function refreshUI(){
  ...
  $("events").textContent=`Best score: ${m.bestScore<=-900?"learning":m.bestScore.toFixed(2)} • curl episodes: ${m.posture.episodes} • uncurl successes: ${m.posture.uncurlSuccess} • sleep gain: ${m.sleep.lastGain}`;
...
try{
  $("status").textContent="v0.12 building world…";
  reset();
  $("status").textContent="v0.12 modular engine running";
}catch(e){
